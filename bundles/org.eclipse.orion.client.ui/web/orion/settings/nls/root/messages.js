...
define({//Default message bundle
	...
	"DeleteLanguageFromConfig": "Delete this language from the configuration",
	...
	"Languages": "Languages",
	"Language Imported": "Language Imported",
	"EditorLanguages": "Editor Languages",
	"EditorLanguagesInfo": "This page manages TextMate language grammars that have been imported",
	...
	"textLanguage": "...or paste a language grammar here",
	"textTheme": "...or paste editor styles here",
	"Import": "Import",
	"Import a theme": "Import a theme",
	"Import a language": "Import a language",
	"Import Language tooltip": "Import a language grammar from a .tmLanguage file",
	"File types": "File types: ${0}",
	"Omiguruma warning": "This grammar uses Regular Expression features that are not natively supported.  As a result editor load time and runtime performance will be degraded for this language and other languages that reference it.",
	"ImportLanguageDialogMessage": "You can import a language grammar here (more TODO)",
