	...
	describe('Esprima Tolerant Parsing Tests', function() {
		...
		it('string literal recovery 6', function() {
			if(Util.isWindows) {
				...
				runTest({
					source: 'var o = {}; o["busted]\nvar f = {};',
					nodes: [{"type":"VariableDeclaration","kind":"var","range":[0,11]},{"type":"VariableDeclarator","range":[4,10]},{"type":"Identifier","name":"o","range":[4,5]},{"type":"ObjectExpression","range":[8,10]},{"type":"ExpressionStatement","range":[12,27]},{"type":"ExpressionStatement","range":[27,34]},{"type":"AssignmentExpression","range":[27,33]},{"type":"Identifier","name":"f","range":[27,28]},{"type":"ObjectExpression","range":[31,33]}],
		...
		it('escaped literal recovery 2', function() {
			runTest({
				source: "function f() {	return {b:{	cc:3, dd:hey\\'' e}c:2};}",
				nodes: [{"type":"FunctionDeclaration","range":[0,45]},{"type":"Identifier","name":"f","range":[9,10]},{"type":"BlockStatement","range":[13,45]},{"type":"ReturnStatement","range":[15,36]},{"type":"ExpressionStatement","range":[36,40]},{"type":"ExpressionStatement","range":[40,43]},{"type":"Literal","range":[40,42]},{"type":"ExpressionStatement","range":[43,44]},{"type":"Identifier","name":"e","range":[43,44]},{"type":"LabeledStatement","range":[45,48]},{"type":"Identifier","name":"c","range":[45,46]},{"type":"ExpressionStatement","range":[47,48]},{"type":"Literal","range":[47,48],"value":2},{"type":"ExpressionStatement","range":[48,50]},{"type":"ExpressionStatement","range":[50,51]}],
		...
		it('escaped literal recovery 3', function() {
			runTest({
				source: "function f() {	return {b:{	cc:3, dd:hey\\' e}c:2};}",
				nodes: [{"type":"FunctionDeclaration","range":[0,50]},{"type":"Identifier","name":"f","range":[9,10]},{"type":"BlockStatement","range":[13,50]},{"type":"ReturnStatement","range":[15,36]},{"type":"ExpressionStatement","range":[36,40]}],
		...
		it('escaped literal recovery 5', function() {
			runTest({
				source: "var v = {a b:{cc:3, dd:'hey' e} c:2};function f() {return {a b:{cc:3, dd:hey\\' e} c:2};}",
				nodes: [{"type":"VariableDeclaration","kind":"var","range":[0,37]},{"type":"VariableDeclarator","range":[4,36]},{"type":"Identifier","name":"v","range":[4,5]},{"type":"ObjectExpression","range":[8,36]},{"type":"Property","kind":"init","range":[11,31]},{"type":"Identifier","name":"b","range":[11,12]},{"type":"ObjectExpression","range":[13,31]},{"type":"Property","kind":"init","range":[14,18]},{"type":"Identifier","name":"cc","range":[14,16]},{"type":"Literal","range":[17,18],"value":3},{"type":"Property","kind":"init","range":[20,28]},{"type":"Identifier","name":"dd","range":[20,22]},{"type":"Literal","range":[23,28],"value":"hey"},{"type":"Property","kind":"init","range":[32,35]},{"type":"Identifier","name":"c","range":[32,33]},{"type":"Literal","range":[34,35],"value":2},{"type":"FunctionDeclaration","range":[37,88]},{"type":"Identifier","name":"f","range":[46,47]},{"type":"BlockStatement","range":[50,88]},{"type":"ReturnStatement","range":[51,73]},{"type":"ExpressionStatement","range":[73,77]}],
		...
		it('Incomplete regex 1', function() {
			runTest({
				source: "/",
                nodes: [{"type":"ExpressionStatement","range":[0,0]}],
		...
		it('Incomplete regex 2', function() {
			runTest({
				source: "function f() { var x;/ }",
                nodes: [{"type":"FunctionDeclaration","range":[0,24]},{"type":"Identifier","name":"f","range":[9,10]},{"type":"BlockStatement","range":[13,24]},{"type":"VariableDeclaration","kind":"var","range":[15,21]},{"type":"VariableDeclarator","range":[19,20]},{"type":"Identifier","name":"x","range":[19,20]},{"type":"ExpressionStatement","range":[21,21]}],
		...
		it('Incomplete regex 3', function() {
			runTest({
				source: "function f() { var x; }/",
                nodes: [{"type":"FunctionDeclaration","range":[0,23]},{"type":"Identifier","name":"f","range":[9,10]},{"type":"BlockStatement","range":[13,23]},{"type":"VariableDeclaration","kind":"var","range":[15,21]},{"type":"VariableDeclarator","range":[19,20]},{"type":"Identifier","name":"x","range":[19,20]},{"type":"ExpressionStatement","range":[23,23]}],
