	...
	describe('Esprima Tolerant Parsing Tests', function() {
		...
		it('obj prop recovery - missing comma 1', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":13,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 2', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":13,"message":"Missing expected ','"},{"lineNumber":1,"index":17,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 3', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":13,"message":"Missing expected ','"},{"lineNumber":1,"index":21,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 4', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":22,"message":"Missing expected ','"},{"lineNumber":1,"index":28,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 5', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":28,"message":"Missing expected ','"},{"lineNumber":1,"index":34,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 6', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":37,"message":"Missing expected ','"},{"lineNumber":1,"index":43,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 7', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":22,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 8', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":22,"message":"Missing expected ','"},{"lineNumber":1,"index":30,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 9', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":31,"message":"Missing expected ','"},{"lineNumber":1,"index":37,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 10', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":25,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 11', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":25,"message":"Missing expected ','"},{"lineNumber":1,"index":29,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 12', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":25,"message":"Missing expected ','"},{"lineNumber":1,"index":33,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 13', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":34,"message":"Missing expected ','"},{"lineNumber":1,"index":40,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - missing comma 14', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":40,"message":"Missing expected ','"},{"lineNumber":1,"index":46,"message":"Missing expected ','"},{"lineNumber":1,"index":51,"message":"Unexpected end of input"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - mixed 1', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":15,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - mixed 2', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":15,"message":"Missing expected ','"},{"lineNumber":1,"index":15,"message":"Unexpected token d","token":"d"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - mixed 3', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":29,"message":"Missing expected ','"},{"lineNumber":1,"index":29,"message":"Unexpected token e","token":"e"},{"lineNumber":1,"index":32,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - mixed 4', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":29,"message":"Missing expected ','"},{"lineNumber":1,"index":29,"message":"Unexpected token e","token":"e"},{"lineNumber":1,"index":32,"message":"Missing expected ','"},{"lineNumber":1,"index":59,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":79,"message":"Missing expected ','"},{"lineNumber":1,"index":79,"message":"Unexpected token e","token":"e"},{"lineNumber":1,"index":82,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - mixed 5', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":15,"message":"Missing expected ','"},{"lineNumber":1,"index":42,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":48,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - mixed 6', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":15,"message":"Missing expected ','"},{"lineNumber":1,"index":15,"message":"Unexpected token d","token":"d"},{"lineNumber":1,"index":44,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":50,"message":"Missing expected ','"},{"lineNumber":1,"index":50,"message":"Unexpected token d","token":"d"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - mixed 7', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":15,"message":"Missing expected ','"},{"lineNumber":1,"index":42,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":48,"message":"Missing expected ','"},{"lineNumber":1,"index":57,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":63,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - mixed 8', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":15,"message":"Missing expected ','"},{"lineNumber":1,"index":15,"message":"Unexpected token d","token":"d"},{"lineNumber":1,"index":44,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":50,"message":"Missing expected ','"},{"lineNumber":1,"index":50,"message":"Unexpected token d","token":"d"},{"lineNumber":1,"index":61,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":67,"message":"Missing expected ','"},{"lineNumber":1,"index":67,"message":"Unexpected token d","token":"d"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - mixed 9', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":29,"message":"Missing expected ','"},{"lineNumber":1,"index":29,"message":"Unexpected token e","token":"e"},{"lineNumber":1,"index":32,"message":"Missing expected ','"},{"lineNumber":1,"index":59,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":79,"message":"Missing expected ','"},{"lineNumber":1,"index":79,"message":"Unexpected token e","token":"e"},{"lineNumber":1,"index":82,"message":"Missing expected ','"},{"lineNumber":1,"index":91,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":111,"message":"Missing expected ','"},{"lineNumber":1,"index":111,"message":"Unexpected token e","token":"e"},{"lineNumber":1,"index":114,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - get/set 1', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":20,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - get/set 2', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":22,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - get/set 3', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":22,"message":"Missing expected ','"},{"lineNumber":1,"index":22,"message":"Unexpected token b","token":"b"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - get/set 4', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":24,"message":"Missing expected ','"},{"lineNumber":1,"index":37,"message":"Missing expected ','"},{"lineNumber":1,"index":37,"message":"Unexpected token b","token":"b"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - get/set 5', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":13,"message":"Unexpected token aa","token":"aa"},{"lineNumber":1,"index":27,"message":"Missing expected ','"},{"lineNumber":1,"index":40,"message":"Missing expected ','"},{"lineNumber":1,"index":40,"message":"Unexpected token b","token":"b"}]
			};
			runTest(data);
		});
		...
		it('obj prop recovery - get/set 6', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":13,"message":"Unexpected token aa","token":"aa"},{"lineNumber":1,"index":27,"message":"Missing expected ','"},{"lineNumber":1,"index":27,"message":"Unexpected token bb","token":"bb"},{"lineNumber":1,"index":43,"message":"Missing expected ','"},{"lineNumber":1,"index":43,"message":"Unexpected token b","token":"b"}]
			};
			runTest(data);
		});
		...
		it('obj prop ident recovery - literal successive 1', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":19,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop ident recovery - literal successive 2', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":9,"message":"Unexpected token a","token":"a"},{"lineNumber":1,"index":17,"message":"Missing expected ','"}]
			};
			runTest(data);
		});
		...
		it('obj prop ident recovery - literal nested successive 1', function() {
			var data = { 
				...
				errors: [{"lineNumber":1,"index":15,"message":"Unexpected token aa","token":"aa"},{"lineNumber":1,"index":26,"message":"Missing expected ','"},{"lineNumber":1,"index":30,"message":"Missing expected ','"}] 
			};
			runTest(data);
		});
