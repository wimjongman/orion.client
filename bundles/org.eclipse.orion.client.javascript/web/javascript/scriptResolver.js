...
'orion/fileMap'
    ...
    Objects.mixin(ScriptResolver.prototype, {
       ...
       setProject: function(projectLocation) {
       ...
       _getFile : function _getFile(name, options) {
           ...
           return FileMap.getFilePrefix(this.fileclient, that.projectLocation || this.fileclient.fileServiceRootURL()).then(function(prefix) {
	           ...
	           return this.fileclient.search(
	                {
	                	'resource': that.projectLocation || this.fileclient.fileServiceRootURL(),
	                    'keyword': searchname,
